...
**We chose the model because OfficeSpace, Number, Nearest and Income are the most significant variables that effect Margin.  We omitted Enrollment and Distance because they did not appear to improve accuracy of expected Margin. The model has the least amount of variables to explain 50% of the expected Margin.  We would not recommend this site given a predicted Margin of 39.6% since this is less than typical profitable inns with Margins of 50%.  The best case scenario in a 95% confidence interval would barely surpass a Margin of 50%.  This site has a very high Number of competitor rooms nearby.**
